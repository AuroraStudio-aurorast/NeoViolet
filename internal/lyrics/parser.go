...
// ErrNoLyrics is returned when a lyric file parses cleanly but contains no
// lyric lines (for example a TTML file with no <p> elements). It lets the
// registry fall back to the next preferred format instead of showing an empty
// file.
