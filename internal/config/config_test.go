...
func TestDefaultConfig(t *testing.T) {
	...
	tests := []struct {
		...
		{"Lyrics.FormatPriority len", len(cfg.Lyrics.FormatPriority), 6},
		{"Lyrics.FormatPriority[0]", cfg.Lyrics.FormatPriority[0], "lrc"},
		{"Lyrics.FormatPriority[1]", cfg.Lyrics.FormatPriority[1], "ttml"},
		{"Lyrics.FormatPriority[2]", cfg.Lyrics.FormatPriority[2], "qrc"},
		{"Lyrics.FormatPriority[3]", cfg.Lyrics.FormatPriority[3], "yrc"},
		{"Lyrics.FormatPriority[4]", cfg.Lyrics.FormatPriority[4], "eslrc"},
		{"Lyrics.FormatPriority[5]", cfg.Lyrics.FormatPriority[5], "lys"},
